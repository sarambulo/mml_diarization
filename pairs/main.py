...
def create_pairs() -> None:
    ...
    for video_id in video_ids:
        try:
            ...
            build_combined_pairs(S3_BUCKET_NAME, video_id, pairs_csv_path, video_buf, audio_buf, meta_buf, audio_type="melspectrogram")
...
if __name__ == "__main__":
    # create_pairs()
    build_combined_pairs(S3_BUCKET_NAME, "00001", "s3://mmml-proj/preprocessed/00001/pairs.csv", [], [], [], batch_size=100, outpath="test", audio_type="melspectrogram")
