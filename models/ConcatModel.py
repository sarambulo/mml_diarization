...
class ConcatenationFusionModel(nn.Module):
    ...
    def __init__(self, audio_model = None, visual_model = None, fusion_dim = 512, embedding_dim =256):
        ...
        #fusion model layers
        self.fusion_linear = nn.Linear(audio_dim + visual_dim, fusion_dim)
    ...
    def forward(self, audio_input, visual_input):
        ...
        #combine
        concat_embedding = torch.cat((audio_embedding, video_embedding), dim=1)
        
        #fusion model
        fusion = self.fusion_fc(concat_embedding)
